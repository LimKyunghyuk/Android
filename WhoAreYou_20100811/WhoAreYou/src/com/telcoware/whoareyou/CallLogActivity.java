...
public class CallLogActivity extends Activity {
	...
	// 안택수 추가부분
	TextView callStatTitle;
	TextView callStatTotal;
	TextView callStatMine;
	// 안택수 추가부분 끝
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 안택수 추가 부분
		callStatTitle = (TextView)findViewById(R.id.CallStatTitle);
		callStatTotal = (TextView)findViewById(R.id.CallStatTotal);
		callStatMine = (TextView)findViewById(R.id.CallStatMine);
		// 안택수 추가부분 끝
	...
	protected void onResume() {
		...
		// 안택수 추가부분 - DB 조회 View
		String db_feed = getString(R.string.db_result_feed);
		...
		dbTotal = dbTotal.replace("REGI:", "전체 DB\n");
		callStatTotal.setText(dbTotal);
		
		int spamReg = configPrefs.getInt("myRegiSpam", 0);
		callStatMine.setText("내가 등록한 DB\n " + spamReg);
		// 안택수 추가부분 끝
	}
