	...
	public static InputStream postData(ArrayList<String> prmtr) {
		...
		try {
			...
			for(int i = 1; i < prmtr.size();  i++){
				nameValuePairs.add(new BasicNameValuePair("val" + i , prmtr.get(i)));
			}	
...
public static String TagFilter(String in, String tag){
...
public static ArrayList<ArrayList> ListTagFilter(InputStream in, ArrayList<String> tagList){
		...
		for(int i = 0;i<items.getLength()-1;i++){
			ArrayList<String> datas = new ArrayList<String>();
			 for(int j=1;j<tagList.size();j++){				
				 NodeList items2 = order.getElementsByTagName(tagList.get(j));
//				 ArrayList<String> datas= new ArrayList<String>();
...
//
//	public static ArrayList<String> TagFilterList(ArrayList<String> in, String tag){
//		
//		DocumentBuilderFactory dbf;
//		String result;
//		InputStream istream; 
